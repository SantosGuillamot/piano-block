...
| `src/style.scss` | Front-end / shared styling only — the `@font-face` declaration and the block-wrapper rules; emitted to `build/style-index.css` and enqueued via `style`. |
